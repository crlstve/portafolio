...
<main class="relative w-full min-h-dvh overflow-x-hidden">
    ...
    <section id="inicio" class="container mx-auto my-12 lg:mt-24 lg:mb-12 flex flex-col-reverse lg:flex-row gap-10 lg:gap-16">
        ...
        <div class="w-fit h-48 aspect-square flex relative mx-auto lg:mx-0">
            <img id="carles-image-light" loading="lazy" src="./assets/images/carles-light.webp" alt="carles esteve" width="250" height="250" class="h-full w-auto aspect-square self-end absolute transition-opacity duration-500 filter drop-shadow shadow-neutral-300">
            <img id="carles-image-dark" loading="lazy" src="./assets/images/carles-dark.webp" alt="carles esteve" width="250" height="250" class="h-full w-auto aspect-square self-end absolute transition-opacity duration-500 filter drop-shadow shadow-neutral-300">
        </div>
