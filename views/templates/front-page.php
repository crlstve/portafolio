...
<main class="relative w-full min-h-dvh overflow-x-hidden">
    ...
    <section id="inicio" class="container mx-auto my-12 lg:my-24 flex flex-col-reverse lg:flex-row gap-10 lg:gap-16">
        ...
        <div class="w-fit h-48 aspect-square flex relative mx-auto lg:mx-0">
            <img id="carles-image-light" src="./assets/images/carles-light.webp" alt="carles esteve" width="250" height="250" class="h-full w-auto aspect-square self-end absolute transition-opacity duration-500">
            <img id="carles-image-dark" src="./assets/images/carles-dark.webp" alt="carles esteve" width="250" height="250" class="h-full w-auto aspect-square self-end absolute transition-opacity duration-500">
        </div>
        ...
        <div class="flex snap-y snap-mandatory">
            <ul class="timeline relative w-full flex flex-wrap gap-y-6 md:gap-y-12 justify-between">
                <li class="bullet after:top-0 before:top-0 snap-always w-full md:w-5/12 flex flex-col h-fit gap-3 p-8 border-l border-t border-white dark:border-slate-600 rounded-lg backdrop-blur-sm shadow-md dark:bg-[rgba(0,0,0,0.1)] md:mt-6 fadeInUp visible relative">
                    ...
                    <div>
                        <p class="text-base dark:text-white font-light">
                            Programación de web con <b>Wordpress</b> y <b>Laravel</b> para su plataforma de elearning. Desarrollo de <b>APIS</b>, bloques de <b>Gutenberg</b>, <b>plugins</b> y <b>templates</b> para <b>Wordpress</b>.
                        </p>
                    </div>
                </li>
                ...
                <li class="bullet after:top-20 before:top-20 w-full md:w-5/12 flex flex-col h-fit gap-3 p-8 border-l border-t border-white dark:border-slate-600 rounded-lg backdrop-blur-sm shadow-md dark:bg-[rgba(0,0,0,0.1)] md:mt-24 fadeInUp visible relative">
                    ...
                    <div>
                        <p class="text-base dark:text-white font-light">
                            Desarrollo de las distintas webs de la empresa con <b>Wordpress</b> y en <b>Hubspot</b> usando <b>HubL</b>. Desarrollo de <b>APIS</b>, <b>plugins</b>, <b>módulos</b>, <b>templates</b> y mantenimiento de las webs.
                        </p>
                    </div>
                </li>
                ...
                <li class="bullet after:top-10 before:top-10 snap-always w-full md:w-5/12 flex flex-col h-fit gap-3 p-8 border-l border-t border-white dark:border-slate-600 rounded-lg backdrop-blur-sm shadow-md dark:bg-[rgba(0,0,0,0.1)] md:-mt-20 fadeInUp relative">
                    ...
                    <div>
                        <p class="text-base dark:text-white font-light">
                            Mantenimiento y actualización de la <b>ecommerce</b> de la empresa con <b>Codeigniter</b>, asi como la creación de otras webs con <b>Wordpress</b>, incluida una <b>ecommerce</b> basada en <b>WooCommerce</b>.
                        </p>
                    </div>
                </li>
                ...
                <li class="bullet after:top-0 before:top-0 w-full md:w-5/12 flex flex-col h-fit gap-3 p-8 border-l border-t border-white dark:border-slate-600 rounded-lg backdrop-blur-sm shadow-md dark:bg-[rgba(0,0,0,0.1)] md:-mt-16 fadeInUp">
                    <header>
                        ...
                        <time class="dark:text-white text-sm" datetime="22/04/24">04-9-2020 | 04-05-2019</time>
