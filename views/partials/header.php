                ...
                <ul aria="menu" class="flex flex-row items-center gap-3 md:gap-10 px-6 py-3 rounded-full backdrop-blur-sm shadow-md shadow-slate-950/20 border-l border-t border-white dark:border-slate-600 dark:bg-[rgba(0,0,0,0.1)] bg-[rgba(255,255,255,0.1)]">
                    ...
                    <li>
                        <button id="btn_mode" aria="menu item" aria-label="Modo oscuro" class="sound group p-2 rounded-full aspect-square bg-transparent relative border-l border-t border-white hover:border-slate-300 hover:dark:border-slate-950 dark:border-slate-600 backdrop-blur hover:backdrop-blur-none shadow-md hover:shadow-inner overflow-hidden" onclick="toggleDarkMode();">
                            ...
                            dark:translate-y-0 group-hover:dark:-translate-y-8 
                    
                            duration-500 
                            
                            -translate-y-8 group-hover:-translate-y-0 
                            
                            group-hover:dark" version="1.1" id="moon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 30.457 30.457" xml:space="preserve">
                            ...
                            <svg class="fill-slate-600 group-hover:fill-violet-500 dark:fill-white group-hover:dark:fill-emerald-300
                            dark:translate-y-3 group-hover:dark:-translate-y-5

                            -translate-y-5 group-hover:translate-y-3

                            duration-500" enable-background="new 0 0 512 512" height="20px" id="sun" version="1.1" viewBox="0 0 512 512" width="20px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
