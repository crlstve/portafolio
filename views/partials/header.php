...
<!-- End Google Tag Manager (noscript) -->    
    <header class="sticky top-0 z-10 crt">
        <div class="w-full py-4 container">
            <nav class="flex flex-row justify-end md:justify-center relative">
                ...
                <ul id="nav-menu" aria="menu" class="fixed w-screen md:w-fit md:relative hidden md:flex md:flex-row flex-wrap justify-center items-center gap-3 md:gap-10 px-6 py-16 md:py-3  backdrop-blur-sm border-l border-t border-white dark:border-slate-600 dark:bg-[rgba(0,0,0,0.1)] bg-[rgba(255,255,255,0.1)] duration-500 top-0 left-0 right-0 bottom-0">
                    ...
                    <li class="flex justify-end md:justify-center">
                        <button id="btn_mode" aria="menu item" aria-label="Modo oscuro" class="sound group p-2 aspect-square bg-transparent relative border-l border-t border-white hover:border-slate-300 hover:dark:border-slate-950 dark:border-slate-600 backdrop-blur hover:backdrop-blur-none overflow-hidden" onclick="toggleDarkMode();">
