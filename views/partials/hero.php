    <section id="inicio" class="container mx-auto my-12 lg:mt-24 lg:mb-12 flex flex-col-reverse lg:flex-row gap-10 lg:gap-28 justify-center">
        <div class="hero-content w-fit flex flex-col gap-3 self-center relative">
            <header class="w-fit mx-auto p-8 md:border-x md:border-t border-white dark:border-slate-600 rounded-sm">
                <h1 class="text-xl font-semibold dark:text-white leading-5 flex flex-col">carles esteve albiach<span data-text="full stack web developer" class="text-3xl md:text-4xl font-title">full stack web developer<span>
                </h1>
                <div class="typewriter w-fit">
                    <p class="text-base dark:text-white">+8 años en el mundo del desarrollo web</p>
                </div>
            </header>                
                <ul class="flex flex-row gap-4 -mt-6 ml-8">
                    <li class="relative">
